...
import com.qureka.skool.di.CANCEL_REQUEST_CODE
import com.qureka.skool.di.CLICK_REQUEST_CODE
import com.qureka.skool.di.RESUME_REQUEST_CODE
import com.qureka.skool.di.STOPWATCH_STATE
import com.qureka.skool.di.STOP_REQUEST_CODE
...
object ServiceHelper {
    ...
    fun clickPendingIntent(context: Context): PendingIntent? {
        val clickIntent = Intent(context, DetailActivity::class.java).apply {
            putExtra(STOPWATCH_STATE, StopWatchIntent.START_SERVICE.name)
        }
