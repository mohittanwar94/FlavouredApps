package com.qureka.skool.custom
...
class ViewFinderOverlay(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private val boxPaint: Paint = Paint().apply {
        ...
        strokeWidth = context.resources.getDimensionPixelOffset(R.dimen._10sdp).toFloat()
    }

    private val scrimPaint: Paint = Paint().apply {
        color = ContextCompat.getColor(context, R.color.black_16)
    }
    ...
    private val boxCornerRadius: Float =
        context.resources.getDimensionPixelOffset(R.dimen._10sdp).toFloat()
