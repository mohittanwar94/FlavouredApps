...
Java_com_qureka_skool_MainGame_nativeGetBestMove(JNIEnv *env, jclass clazz, jobjectArray grid) {
    board_t board = 0;
...
Java_com_qureka_skool_MainGame_nativeSetMaxDepth(JNIEnv *env, jclass clazz, jint depth) {
    maxDepth = depth;
}